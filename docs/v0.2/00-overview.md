...
8. ~~The **とびら → と + びら** split~~ **Reported 2026-09-26** by claritise, with the refined pass's over-splitting (`../reference/lexirise-api-notes.md`, "The second `analyze/text` pass, measured"): the refined answer splits it too. (Earlier plan, 2026-09-25: report it only if still split after v0.2.)
